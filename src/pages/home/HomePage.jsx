  ...
  return (
    <>
      <div className="form-contain">
          ...
          <Typewriter
            ...
            onInit={(typewriter) => {
              typewriter
                ...
                .pauseFor(1000)
                .deleteAll()
                .typeString("TRAIN TICKET BOOKING")
        ...
        <p className="title">Powered By Prediction &amp; Alternates</p>
        ...
        <div className="card-group">
          <div className="card click">
            ...
            <div className="card-body">
              ...
              <p className="card-text">
                ...
                amenities are amalgamated for an “Experience Unsurpassed”. It
                has been a winner of “World’s Leading Luxury train” by World
                Travel Awards consecutively for last six years.
              </p>
            </div>
          ...
          <div className="card click">
            ...
            <div className="card-body">
              ...
              <p className="card-text">
                Book My Train offers Exclusive Rail tour packages with confirmed
                train tickets, sight-seeing and meals for enchanting Nilgiri
                Mountains, Darjeeling, Kullu Manali, Kashmir, Gangtok or divine
                tours of Mata Vaishno Devi, Rameswaram, Madurai, Shirdi,
                Tirupati etc. Holiday packages/ Land packages to these
          ...
          <div className="card click">
            ...
            <div className="card-body">
              ...
              <p className="card-text">
                ...
                or Picturesque Islands, Book My Train has it all. Discover India
                through Book My Train!
              </p>
            </div>
            <div className="card-footer">
              <small className="text-muted">Last updated 3 mins ago</small>
